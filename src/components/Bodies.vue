    ...
    >
      <article class="media">
        ...
        <div class="media-content">
          <div class="content">
            <p>
              <strong style="color: #ffffff;">{{ body.name }}</strong>
            </p>
          </div>
        </div>
        <div class="media-right">
          <button v-on:click="deleteBody(body.id)"
...
export default {
  name: 'Bodies',
  methods: {
    ...mapActions(['fetchBodies', 'deleteBody', 'updateBody']),
  },
  computed: mapGetters(['allBodies']),
  created() {
    this.fetchBodies();
  },
  mounted() {
